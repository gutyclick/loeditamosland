...
export function ServiceSeoPage({ data }: { data: ServicePageData }) {
  const url=`https://loeditemos.com/servicios/${data.slug}`;
  const jsonLd=[
    {"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"Inicio",item:"https://loeditemos.com"},{"@type":"ListItem",position:2,name:"Servicios",item:"https://loeditemos.com/#servicios"},{"@type":"ListItem",position:3,name:data.title,item:url}]},
    {"@context":"https://schema.org","@type":"Service",name:data.title,description:data.intro,url,provider:{"@id":"https://loeditemos.com/#organization"},areaServed:["PA","US","MX","CO"],availableChannel:{"@type":"ServiceChannel",serviceUrl:url,servicePhone:"+1-551-309-0145"}},
