...
export const metadata: Metadata = { title: "Política de cookies", description: "Información sobre el uso de cookies y tecnologías similares en LoEditamos.", alternates: { canonical: "/cookies" }, robots: { index: false, follow: true } };
